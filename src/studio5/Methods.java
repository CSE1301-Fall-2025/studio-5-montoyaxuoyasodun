...
public class Methods {
	...
	public static void drawBullsEye(double x, double y, double radius) {
		...
		// Blue ring with 3.0/4.0 the radius 0.5
		// suggested rgb values: 0, 109, 219
		StdDraw.setPenColor(0,109,219);
		StdDraw.filledCircle(x,y,0.75*radius);
		

		// Red ring with 1.0/2.0 the radius --> 0.1875
	...
	/**
	 * 
	 * @param values the array to calculate the mean of
	 * @return the mean of the values within the array
	 */
